      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(title,maxLines:3,overflow:TextOverflow.visible,style: const TextStyle(fontSize: 20,fontWeight: FontWeight.w600)),
            Container(
              height: 220,
            ...
            SizedBox(height: 10,),
            Expanded(child: Text(description,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500))),
          ],
        ),
      )
    );
